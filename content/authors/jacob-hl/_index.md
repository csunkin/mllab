...
social:
  - icon: envelope
    icon_pack: fas
    link: mailto:jacob.hinkellipsker@csun.edu
  - icon: twitter
    icon_pack: fab
    link: https://twitter.com/Jake_HL
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/jacob-hinkel-lipsker-5376447b/
  - icon: researchgate
    icon_pack: ai
    link: https://www.researchgate.net/profile/Jacob-Hinkel-Lipsker
education:
  courses:
    - course: Ph.D. in Human Physiology
      institution: University of Oregan
      year: 2017
    - course: M.S Kinesiology
